                ...
                <div className='flex flex-col lg:flex-row items-center gap-2'>
                    ...
                    <div className='w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left'>
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <Link as={'button'} href={'/login'} className='bg-[#1CB3C8] text-[#DFE2E2] w-52 font-plus-jakarta font-semibold px-2 py-2 rounded-lg shadow-md hover:text-[#738598] hover:bg-white duration-300'>Buat Laporan   </Link>
                        </motion.div>
                    </div>
