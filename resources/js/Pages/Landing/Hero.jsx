                ...
                <div className='flex flex-col lg:flex-row items-center gap-2'>
                    ...
                    <motion.div
                        ...
                        >
                            ...
                            >
                                <Link as={'button'} href={'/login/student'} className='bg-[#00e1ff] text-slate-900 w-52 font-plus-jakarta font-semibold px-2 py-2 rounded-lg shadow-md hover:text-[#738598] hover:bg-white duration-300'>
                                    Buat Laporan
                                </Link>
                            </motion.div>
                        </motion.div>
