    ...
    return (
        <Side>
            ...
            <h1 className="font-plus-jakarta">
                Here's a list of the user for you
            </h1>
            ...
            <div className="flex items-center w-full gap-4">
                <div className="flex-1">
                    ...
                    <form className="flex items-center" onSubmit={handleSearch}>
                        <input
                            ...
                            className="rounded-lg outline-none shadow-sm border-2 py-[6px] px-2 w-full"
                ...
                >
                    <MdAdd className="flex justify-center mt-1 mr-1 text-xl" />
                    Add User
                </button>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow mt-8">
                ...
                <div>
                    {users.data.map((user, index) => (
                        <div
                            key={user.id}
                            className="grid grid-cols-4 border-t place-items-start justify-around font-inter hover:bg-gray-200 transition-all"
                        >
                            <div className="px-4 py-4">{index + 1}</div>
                            <div className="px-4 py-4">{user.name}</div>
                            <div className="px-4 py-4">{user.email}</div>
            ...
            <div className="p-[15px]">
                <div className="flex justify-end">
                    ...
                    <button
                        onClick={() => handlePagination(users.first_page_url)}
                    ...
                    <button
                        onClick={() => handlePagination(users.last_page_url)}
                        className="border px-4 py-2 duration-200 rounded-lg mx-[2px] bg-white hover:bg-gray-400 disabled:opacity-30 disabled:hover:cursor-not-allowed disabled:hover:bg-white"
            ...
            {isOpen && (
                ...
                <div className="fixed bg-black/50 inset-0 backdrop-blur-sm flex justify-center items-center p-4">
                    ...
                    <div className="bg-white rounded-lg w-full max-w-2xl m-4 p-4">
                        <h1 className="text-center font-bold font-plus-jakarta text-[35px] mb-[20px] pt-4">
                        ...
                        <form onSubmit={submit} method="POST">
                            <div className="flex flex-col mx-4 my-4 gap-4">
                                ...
                                <div className="flex flex-col">
                                    <label className="fon2t-plus-jakarta font-semibold">
                                        Password
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div className="flex flex-col">
                                    <label className="font-plus-jakarta font-semibold text-gray-400">
                                        <i>Role</i>
                                    </label>
                                    <input
                                        type="text"
